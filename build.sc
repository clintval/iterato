...
/** The iterato Scala package package. */
object iterato extends ScalaModule with PublishModule with ScoverageModule {
  ...
  def pomSettings: Target[PomSettings] = PomSettings(
    description    = "Safe and completely lazy parallel iteration in Scala",
    organization   = "io.cvbio.collection",
    url            = "https://github.com/clintval/iterato",
    licenses       = Seq(License.MIT),
    versionControl = VersionControl.github(owner = "clintval", repo = "iterato", tag = Some(packageVersion)),
  ...
  override def artifactName: T[String] = T { "iterato" }
